...
var passwordCheckOld = function () 
{
    ...
    if(checkLength(stringPassword) === true)
    {
        ...
        {
            stringOutput = stringMessage1 + "\n" + stringMessage3; //>=8 characters & not a bad password
        }
        else
        {
            stringOutput = stringMessage1 + "\n" + stringMessage4; //>=8 characters & is a bad password
        }
    }
    else
    {
    ...
    //output message and clears input box
...
//FUNCTIONS
function checkLength(password) //checks to see if password is 8 characters long or not
{
    if(password.length >= 8)
    {
        return true; //password is at least 8 characters long
    }
    else
    {
        return false; //password is NOT at least 8 characters long
    }
};

function checkBad(password, array) //checks to see if password is in the bad passwords array 
{
    if(array.includes(password) === true)
    {
        return true; //password is in the array
    }
    else
    {
        return false; //password is NOT in the array
    }
};

//clears inputs/outputs when site is refreshed
